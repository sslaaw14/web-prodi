                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?= $row['isi'] ?></td>
                          <td><?= $row['tanggal'] ?></td>
                          <td><a href="delete.php?id=<?= $row['ko_id'] ?>" onclick="return confirm('Yakin Ingin menghapus?')"><button type="button" class="btn btn-danger"><i class="menu-icon mdi mdi-delete"></i></button></a></td>
                        </tr>
                      </tbody> 
<?php endforeach ?>					  
                    </table>
                      <a href="listkegiatan.php"><button type="button" class="btn btn btn-success mr-2">Kembali</button></a>
                  </div>
                </div>
              </div>
            </div>
