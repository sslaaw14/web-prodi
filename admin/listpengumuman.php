...
include 'config.php';
$orang=$_SESSION['usid'];
$query="select p.pe_id,p.judul,p.tanggal,u.nama from pengumuman p,user u where p.us_id=u.us_id and p.us_id='$orang' order by p.pe_id DESC LIMIT $offset, $rowsPerPage";
$hasil=mysqli_query($conn,$query) or die (mysqli_error($conn));

$query   = "SELECT COUNT(pe_id) AS numrows FROM pengumuman where us_id='$orang'";
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
<?php while(list($id,$judul,$tgl,$nama)=mysqli_fetch_array($hasil)){?>
                        <tr>
                          <td><?php echo $judul?></td>
                          <td><?php echo $tgl?></td>
                          <td><?php echo $nama?></td>
                          <td><a href="updatepengumuman.php?updt=<?php echo $id?>"><button type="button" class="btn btn-light"><i class="menu-icon mdi mdi-table-edit"></i></button></a> </td>
                          <td><a href="deletepengumuman.php?del=<?php echo $id?>" onclick="return confirm('Yakin Ingin menghapus?')"><button type="button" class="btn btn-danger"><i class="menu-icon mdi mdi-delete"></i></button></a></td>
                        </tr>
                          <?php }?>
                      </tbody>
                        <?php
                      ...
                      <a href="newpengumuman.php"><button type="button" class="btn btn-icons btn-inversed btn-success"><i class="menu-icon mdi  mdi-comment-plus-outline"></i></button></a>
                  </div>
                </div>
              </div>
            </div>
