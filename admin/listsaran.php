...
include 'config.php';
$orang=$_SESSION['usid'];
$query="select * from saran order by sar_id DESC LIMIT $offset, $rowsPerPage";
$hasil=mysqli_query($conn,$query) or die (mysqli_error($conn));

$query   = "SELECT COUNT(sar_id) AS numrows FROM saran";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">List Saran</h4>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
<?php while(list($id, $nama, $telpon, $email, $saran)=mysqli_fetch_array($hasil)){?>
                        <tr>
                          <td><?php echo $id?></td>
                          <td><?php echo $nama?></td>
