...
include 'config.php';
$query="select us_id,uname,nama,status from user order by us_id DESC LIMIT $offset, $rowsPerPage";
$hasil=mysqli_query($conn,$query) or die (mysqli_error($conn));

$query   = "SELECT COUNT(us_id) AS numrows FROM user";
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
<?php while(list($id,$uname,$nama,$status)=mysqli_fetch_array($hasil)){?>
                        <tr>
                          <td><?php echo $uname?></td>
                          <td><?php echo $nama?></td>
                          <td><?php echo $status?></td>
                          <td><a href="updateuser.php?updt=<?php echo $id?>"><button type="button" class="btn btn-light"><i class="menu-icon mdi mdi-table-edit"></i></button></a> </td>
                          <td><a href="deleteuser.php?del=<?php echo $id?>" onclick="return confirm('Yakin Ingin menghapus?')"><button type="button" class="btn btn-danger"><i class="menu-icon mdi mdi-delete"></i></button></a></td>
                        </tr>
                          <?php } ?>
                      </tbody>                        
                       <?php
                      ...
                      <a href="newuser.php"><button type="button" class="btn btn-icons btn-inversed btn-success"><i class="menu-icon mdi mdi-account-plus"></i></button></a>
                  </div>
                </div>
              </div>
            </div>
