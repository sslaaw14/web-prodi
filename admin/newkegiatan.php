        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Buat Kegiatan Baru</h4>
                  <p class="card-description">
                    Masukkan info Kegiatan baru di sini
                  </p>
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="editor" rows="10" name="isi"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success mr-2" name="btn-simpan">Create</button>
                  </form>
                </div>
              </div>
            </div>
