...
if(isset($_POST['add']))
    {
        ...
        else
        {
            ...
            $result=mysqli_query($conn,$query) or die('query gagal uname'.mysqli_error($conn));
            ...
            else
            {
                ...
                {
                    $query = "insert into user (uname,nama,password,status) VALUES ('$username','$nama','$password','dosen')";
                    mysqli_query($conn, $query) or die('Error, query failed' . mysqli_error());         
                    mysqli_close($conn);
                    $message = "Tambah dosen baru '$username' BERHASIL";
                }
            }
        }
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Masukkan info user baru di sini
                  </p>
                  <form class="forms-sample" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="exampleInputName1" placeholder="Password" name="password2">
                    </div>
                    <button type="submit" class="btn btn-success mr-2" name="add">Create</button>
                  </form>
                </div>
              </div>
            </div>
