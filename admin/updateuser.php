...
include 'config.php';
$id=$_GET['updt'];
$query="select uname,nama from user where us_id='$id'";
$hasil=mysqli_query($conn,$query) or die (mysqli_error($conn));
list($uname,$nama)=mysqli_fetch_array($hasil);
...
{    
    ...
    $nama = $_POST['nama'];
	$id=$_GET['updt'];
	$query = "UPDATE user SET uname='$uname' , nama='$nama' WHERE us_id=$id";
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Masukkan info user di sini
                  </p>
                  <form class="forms-sample" action="" method="post">
                    <div class="form-group">
                      <label for="exampleInputName1">Username</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Username" name="uname" value="<?php echo $uname?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Nama</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nama" name="nama" value="<?php echo $nama?>">
                    </div>
